...
const AdditionalInfo = (props) => {
  ...
  return (
    <ul className={tableCell ? "" : "bg-slate-800/30 p-2 rounded border-l-2 border-blue-400 mb-1"}>
      {!!overviewUri && <li><a href={overviewUri} target='_blank' rel='noopener noreferrer' className="text-xs text-blue-400 hover:text-blue-300">Overview</a></li>}
      {!!termsUri && <li><a href={termsUri} target='_blank' rel='noopener noreferrer' className="text-xs text-blue-400 hover:text-blue-300">Terms</a></li>}
      {!!eligibilityUri && <li><a href={eligibilityUri} target='_blank' rel='noopener noreferrer' className="text-xs text-blue-400 hover:text-blue-300">Eligibility</a></li>}
      {!!feesAndPricingUri && <li><a href={feesAndPricingUri} target='_blank' rel='noopener noreferrer' className="text-xs text-blue-400 hover:text-blue-300">Fee and Pricing</a></li>}
      {!!bundleUri && <li><a href={bundleUri} target='_blank' rel='noopener noreferrer' className="text-xs text-blue-400 hover:text-blue-300">Bundle</a></li>}
